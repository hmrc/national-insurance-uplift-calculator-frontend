...
class EmploymentStatusSpec extends AnyFreeSpec with Matchers with ScalaCheckPropertyChecks with OptionValues {

  "EmploymentStatus" - {

    "must deserialise valid values" in {

      val gen = Gen.oneOf(EmploymentStatus.values.toSeq)
