...
case class EmployedCalculation private(
...
object EmployedCalculation {

  def apply(annualSalary: BigDecimal): EmployedCalculation = {
    ...
    EmployedCalculation(annualSalary, period1, period2, saving)
  }

    private def monthlyNi(monthlySalary: BigDecimal, rates: EmployedRates): BigDecimal = {
